...
--
-- Host: localhost    Database: velodromo
-- ------------------------------------------------------
...
CREATE TABLE `ciclista` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_idequipo` (`id_equipo`),
  KEY `fk_idusuario` (`id_usuario`),
  CONSTRAINT `fk_idequipo` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id`),
...
INSERT INTO `ciclista` VALUES (1,1,1),(2,1,2);
...
INSERT INTO `rol` VALUES (1,'Admin',410113),(2,'Usuario',NULL);
...
INSERT INTO `usuario` VALUES (1,'Mateo','Riesco','Maseto','81dc9bdb52d04dc20036dbd8313ed055','mateo.reisco@maristak.net',1),(2,'Abde','Latif','Abdelaptop','81dc9bdb52d04dc20036dbd8313ed055','abde@gmail.com',2);
...
CREATE TABLE `vuelta` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_ciclista` int DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `tiempo` timestamp NULL DEFAULT NULL,
  `num_vuelta` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_idciclista` (`id_ciclista`),
  CONSTRAINT `fk_idciclista` FOREIGN KEY (`id_ciclista`) REFERENCES `ciclista` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-23 21:55:22
